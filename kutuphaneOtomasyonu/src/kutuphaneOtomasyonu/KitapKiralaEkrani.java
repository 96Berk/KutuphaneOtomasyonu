			...
			public void actionPerformed(ActionEvent e) {
				...
				java.util.Date teslimTarihi = null;
					...
					try {
						...
						JOptionPane.showMessageDialog(contentPane, "Tarih bilgileri yanlış, lütfen yyyy-aa-gg olacak şekilde griniz.", "Hata", JOptionPane.ERROR_MESSAGE);
					}
				...
				sql= "INSERT INTO kitapkiralama (kullanici_id, kitap_id, alma_tarihi, teslim_tarihi) VALUES ('"+kullaniciId+"', '"+kitapId+"', '"+sqlAlmaTarihi+"', '"+sqlTeslimTarihi+"')";
				try {
					VeriTabaniBaglantisi.ekle(sql);
					JOptionPane.showMessageDialog(contentPane, adSoyad+" kitabı başarıyla kiraladiniz");
					alisTarihi_alani.setText("");
					teslimTarihi_alani.setText("");
				}catch(Exception e5) {
					
					JOptionPane.showMessageDialog(contentPane, "Kitap Kiralanamadi!", "Hata5", JOptionPane.ERROR_MESSAGE);
				}
